...
const Home = (props: HomeProps) => {
    ...
    function displaySuccess(mintPublicKey: any, qty: number = 1): void {
        ...
        setSolanaExplorerLink(cluster === "devnet" || cluster === "testnet"
            ? ("https://solscan.io/leaderboard/token" + mintPublicKey + "?cluster=" + cluster)
            : ("https://solscan.io/leaderboard/token" + mintPublicKey));
        throwConfetti();
    };
                    ...
                    <DesContainer>
                        <NFT elevation={3} className="nft">
                            ...
                            {/* {wallet && isActive && solanaExplorerLink &&
                                ...
                                <SolExplorerLink href="https://solscan.io/account/99Y54ukHu1RyKgfRj8foUqY6WgVSNy7UqBff4dJrmFxC#portfolio" target="_blank">View on Solscan</SolExplorerLink>
                        </NFT>
                    </DesContainer>
                </MintContainer>
            </MainContainer>
